...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.large_phase_shifting_plant('run_10000')
        ...
        .outputFluids(Fluid.of('gtceu:antimatter', 10000))
        .circuit(5)
